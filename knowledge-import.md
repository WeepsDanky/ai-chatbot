...
#### Knowledge and Documents <a href="#knowledge-and-documents" id="knowledge-and-documents"></a>
...
#### Create a knowledge <a href="#create-a-knowledge" id="create-a-knowledge"></a>
...
#### Uploading Documents By upload file <a href="#uploading-documents-by-upload-file" id="uploading-documents-by-upload-file"></a>
...
#### Text Preprocessing and Cleaning <a href="#text-preprocessing-and-cleaning" id="text-preprocessing-and-cleaning"></a>
...
#### Modify Documents <a href="#modify-documents" id="modify-documents"></a>
...
#### Disabling and Archiving of Documents <a href="#disabling-and-archiving-of-documents" id="disabling-and-archiving-of-documents"></a>
...
#### Maintain Knowledge via API <a href="#maintain-knowledge-via-api" id="maintain-knowledge-via-api"></a>

Head to [Maintain Knowledge Via Api](<.gitbook/assets/maintain dataset via api>).

#### Knowledge Settings <a href="#knowledge-settings" id="knowledge-settings"></a>
...
#### Integrate into Applications <a href="#integrate-into-applications" id="integrate-into-applications"></a>
